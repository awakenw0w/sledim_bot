...
*Ссылка на бота: https://t.me/PROSLEDIL_BOT (стабильная версия)*

*(на сервере в боте неполная версия, без телеграм мониторинга, полную версию запускать локально на пк - ВРЕМЕННО РАБОТАЕТ НЕСТАБИЛЬНО)*
